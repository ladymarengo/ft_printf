...
#    Updated: 2022/02/02 14:19:51 by nsamoilo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FT_PRINTF_FUNCTIONS = ft_printf parse_flags parse_length parse_precision parse_width \
			print_specifier print_left_or_right print_cs ft_itoa_base ft_atoi ft_itoa_without_sign \
			...
			ft_tolower ft_str_toupper print_poux print_f
